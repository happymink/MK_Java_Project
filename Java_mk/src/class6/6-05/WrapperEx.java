...
public class WrapperEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(Integer.bitCount(28)); //28에 대한 2진수의 1의개수
		
		Double d = Double.valueOf(3.14);
		System.out.println(d.toString()); //Double 문자열 3.14로 변환
		System.out.println(Double.parseDouble("3.14")); //문자열 3.14를 실수로 변환
		
		boolean b = (4>3); //b 는 true
		System.out.println(Boolean.toString(b)); //true 문자열로 변환
